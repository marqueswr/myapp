        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-wrap -m-4">
                ...
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                    ...
                    <div class="mt-4">
                        <h2 class="text-gray-900 title-font text-lg font-medium">{{ $aluno->ra }}</h2>
                        <p class="mt-1">{{ $aluno->nome }}</p>
                    </div>
                   {{--  <a href="{{ route('aluno', $aluno->slug) }}" class="mt-3 text-indigo-500 inline-flex items-center">Ver mais
